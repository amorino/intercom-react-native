import type { MetaData, HelpCenterCollectionItem, HelpCenterCollectionContent, HelpCenterArticleSearchResult } from './types';
import type { UserAttributes } from './NativeIntercomSpec';
export type { Company, CustomAttributes, MetaData, HelpCenterArticle, HelpCenterSection, HelpCenterCollectionItem, HelpCenterCollectionContent, HelpCenterArticleSearchResult, } from './types';
...
export type IntercomType = {
     ...
     */
    loginUserWithUserAttributes: (params: Pick<UserAttributes, 'email' | 'userId'>) => Promise<boolean>;
    /**
